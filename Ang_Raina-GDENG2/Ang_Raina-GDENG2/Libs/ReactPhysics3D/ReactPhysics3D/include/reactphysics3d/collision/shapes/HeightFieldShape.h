...
inline decimal HeightFieldShape::getHeightAt(int x, int y) const {
    ...
    switch(mHeightDataType) {
		#if defined(IS_RP3D_DOUBLE_PRECISION_ENABLED)
    case HeightDataType::HEIGHT_FLOAT_TYPE: return (double)((float*)mHeightFieldData)[y * mNbColumns + x];
        ...
        case HeightDataType::HEIGHT_DOUBLE_TYPE: return (float)((double*)mHeightFieldData)[y * mNbColumns + x];
		#endif
