...
void QuadObject::Initialize(void* shaderByteCode, size_t sizeShader, Vector3D color)
{
	...
	{
		//X - Y - Z
		{Vector3D(-0.7f,-0.5f,0.0f),    Vector3D(-0.32f,-0.11f,0.0f),   Vector3D(0,0,0),  Vector3D(0,1,0) }, // POS1
		{Vector3D(-0.5f,0.65f,0.0f),     Vector3D(-0.11f,0.78f,0.0f),    Vector3D(1,1,0),  Vector3D(0,1,1) }, // POS2
		{ Vector3D(0.2f,0.4f,0.0f),     Vector3D(0.75f,0.73f,0.0f),   Vector3D(0,0,1),  Vector3D(1,0,0) },// POS2
		{ Vector3D(0.3f,-0.5f,0.0f),      Vector3D(0.88f,-0.77f,0.0f),    Vector3D(1,1,1),  Vector3D(0,0,1) }
	};
